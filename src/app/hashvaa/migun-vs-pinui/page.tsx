...
const TITLE = "שיפור מיגון מול פינוי בינוי 2026: מתי כל פתרון מתאים | התחדשות";
const DESCRIPTION =
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו לא יזמים. אנחנו חברת בנייה שמבצעת שיפור מיגון, ומלווה דיירים בפרויקטי פינוי בינוי. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
