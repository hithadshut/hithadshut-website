  ...
  const faqs = [
    {
      ...
      a: area.isFrontLine
        ? `${area.name} מסווגת באזור בדרישות פקע״ר מחמירות, ולכן ממ״ד סטנדרטי של 9 מ״ר נע בטווח 180,000-230,000 ₪ + מע״מ ו-12 מ״ר סביב 230,000-270,000 ₪ + מע״מ. התוספת לעומת ערי פנים הארץ נובעת מעובי קירות גדול יותר ודרישות מחמירות לדלת ולחלון הדף. שיפור מיגון חדר זול יותר. ההצעה הסופית ניתנת אחרי סיור ומדידה.`
        : `העלות של ${svc.name} ב${area.name} משתנה לפי סוג הנכס, גודל ומיקום מדויק. בבניית ממ״ד טיפוסי טווחי המחיר נעים בין 160,000 ל-220,000 ₪ + מע״מ. שיפור מיגון חדר קיים זול יותר. ההצעה הסופית ניתנת אחרי סיור ומדידה.`,
    },
    {
