        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[var(--color-muted)] leading-relaxed">
              {area.localNote ??
                `אנחנו מבצעים פרויקטים של בניית ממ״ד ומיגון ב${area.name} וסביבתה. חברת בינוי ויזמות עם קבלנים רשומים, מהנדסים ואדריכלים שפועלים תחת חוזה אחד ואחריות אחת, מהתכנון ועד מסירת המפתח.`}{" "}
