...
const DESCRIPTION =
  "חברת התחדשות בינוי ויזמות בונה ממ״דים, מיגון חדרים ומיגוניות ב-28 אזורי שירות בכל הארץ: מרכז, שרון, שפלה, דרום, צפון וירושלים. ליווי מלא ואישור פקע״ר. קבלו הצעת מחיר תוך 24 שעות.";
