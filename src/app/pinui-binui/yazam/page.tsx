  ...
  return (
    <>
      ...
      <PageHero
        ...
        title="יזם פינוי בינוי 2026: איך בוחרים, 12 שאלות ודגלים אדומים"
        subtitle="מדריך 2026 לנציגות דיירים ולבעלי דירות שעומדים לבחור יזם: 12 שאלות הכרחיות, 8 דגלים אדומים, מי מחליט בפועל, אילו ערבויות חובה לדרוש, והשוואת הצעות."
        crumbs={[
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <div
              ...
              aria-labelledby="bekitzur-yazam"
            >
              <h2 id="bekitzur-yazam" className="text-xl md:text-2xl font-black text-[var(--color-primary)] mb-3">
                בקצרה: איך בוחרים יזם פינוי בינוי
              </h2>
              <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-0">
                יזם פינוי בינוי הוא הגורם העסקי שמתקשר עם הדיירים, מממן את הבנייה,
                ולוקח אחריות כוללת על הפרויקט. הבחירה ביזם היא החלטה של הדיירים עצמם,
                לרוב באמצעות נציגות דיירים והליך הצבעה או חתימה משותפת, ולא החלטה של
                גורם חיצוני מטעמם. לפני חתימה חובה לבדוק ניסיון מוכח, יציבות פיננסית,
                ערבויות תקניות, ולשאול 12 שאלות ממוקדות שמפורטות במדריך זה.
              </p>
            </div>
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="mi-machlit" title="מי מחליט על היזם: הדיירים, לא גורם חיצוני">
            <p>
              בחירת יזם היא החלטה שמתקבלת על ידי בעלי הדירות בבניין או במתחם עצמם, ולא
              על ידי עורך דין, יועץ, או כל גורם אחר מטעמם. בפועל, ברוב הפרויקטים
              הדיירים בוחרים נציגות דיירים שמנהלת מולם את המשא ומתן, אוספת הצעות
              ומגבשת המלצה, אך ההחלטה הסופית והחתימה על ההסכם נשארות בידי כל בעל דירה
              בנפרד.
            </p>
            <p>
              הרוב הנדרש לחתימה על הסכם עם יזם נגזר מהרוב הנדרש להתקדמות הפרויקט עצמו,
              כפי שמפורט במדריך{" "}
              <Link
              ...
              . עד לחתימה בפועל, אף דייר אינו מחויב ליזם מסוים, ולכן שלב הבדיקה וההשוואה
              שמפורט במדריך זה הוא בעל משקל ממשי, ולא רק פורמלי.
            </p>
            <p>
              מומלץ שנציגות הדיירים תיעזר בעורך דין דיירים ולעיתים גם ביועץ הנדסי או
              שמאי מטעם הדיירים, בלתי תלויים ביזם, כדי לגבש עמדה מקצועית לפני שההחלטה
              מובאת להצבעה או לחתימה של כלל הדיירים.
            </p>
          </ContentSection>
        </Reveal>
      </Section>
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="12-shealot" title="12 השאלות שחובה לשאול לפני בחירה">
            ...
            <p>
              מבחינה חוקית, תוכן ההסכם מול הדיירים כפוף לדרישות תוכן שקבע המחוקק
              לעסקאות מסוג זה, ובהן חובת ערבויות להבטחת זכויות הדיירים בשלבי הפרויקט
              השונים, לרבות תקופת הבנייה ותקופת הביניים עד המסירה. הפירוט המלא של
              סוגי הערבויות, מה כל אחת מכסה, ומה אסור לקבל במקומה, מרוכז במדריך{" "}
              <Link
                href="/pinui-binui/eravut"
                className="font-bold text-[var(--color-primary)] underline underline-offset-4 hover:text-[var(--color-accent-dark)]"
              >
              ...
              . יזם שמסרב לספק ערבויות תקניות, או שמציע ערבות חלקית בלבד, הוא דגל אדום
              משמעותי בפני עצמו.
            </p>
          </ContentSection>
        </Reveal>
