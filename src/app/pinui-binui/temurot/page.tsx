...
const faqs = [
  ...
  },
  {
    ...
    a: "בפינוי בינוי קיים פטור ממס שבח בתנאים מסוימים, המוגדרים בסעיף 49לג1 [טעון אימות לסעיף] לחוק מיסוי מקרקעין (שבח ורכישה), תשכ\"ג-1963. הפטור כפוף לעמידה בתנאים ספציפיים, ולא חל אוטומטית על כל פרויקט. רשות המסים פרסמה ב-2026 [טעון אימות לתאריך מדויק] נייר עמדה שמרחיב את הפטור גם ליורשי דירות במתחמי התחדשות עירונית. כל מקרה לגופו, וייעוץ עם עורך דין מקרקעין לפני חתימה הוא הכרחי.",
  },
  {
      ...
      <Section tone="white">
        <Reveal>
          <ContentSection id="dirat-temura" title="מה זה דירת תמורה?">
            <p>
              &ldquo;דירת תמורה&rdquo; משמעותה דירה חדשה במתחם הנבנה, באותה זכות בעלות כמו הדירה הישנה. בעל דירה ישנה אחת מקבל דירה חדשה אחת. אין מצב של &ldquo;חצי דירה&rdquo; או &ldquo;תמורה משותפת&rdquo; בין כמה דיירים. דירת התמורה נבנית במתחם בו עומדת הדירה הישנה, לא בפרויקט אחר ולא בעיר אחרת. [טעון אימות לציטוט סעיף ספציפי בחוק]
            </p>
            <p>
      ...
      <Section tone="soft">
        <Reveal>
          ...
          <div className="mt-8 max-w-5xl">
            <ComparisonTable
              caption="טווחי תוספת מטר טיפוסיים בפרויקטי פינוי בינוי לפי אזור, נכון ל-2026 [טעון אימות]"
              columns={[
        ...
        <Reveal>
          <ContentSection id="shidrug" title="שדרוג דירה: מתי משלמים מהכיס?">
            ...
            <ul className="mt-2 space-y-3 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              ...
              <li>
                <strong className="text-[var(--color-primary)]">שדרוג קומה:</strong> עלייה לקומה גבוהה יותר עולה כסף, ירידה לקומה נמוכה יותר מחזירה כסף. שדרוג קומה אחת בפרויקט פינוי בינוי במרכז הארץ עולה כיום בין 50,000 ל-150,000 ש״ח [טעון אימות], בהתאם לפרויקט.
              </li>
              <li>
              ...
              <li>
                <strong className="text-[var(--color-primary)]">שדרוג גודל:</strong> רכישת מ״ר נוספים מעבר לתמורה הסטנדרטית. במרכז הארץ ב-2026, רכישת מ״ר נוספים בפרויקט פינוי בינוי עולה 20,000 עד 40,000 ש״ח למ״ר [טעון אימות].
              </li>
            </ul>
            <p>
      ...
      <Section tone="white">
        <Reveal>
          <ContentSection id="pitsui" title="פיצוי כספי: מתי, ולמה">
            ...
            <p>
              פיצוי כספי טיפוסי במרכז הארץ נכון ל-2026 נע בין 50,000 ל-300,000 ש״ח לדייר [טעון אימות], בנוסף לדירת התמורה. הסכום תלוי באזור, בערך הקרקע, ובכוח המיקוח של הנציגות. במתחמים בפריפריה הפיצוי הכספי נדיר יותר ולעיתים נעדר.
            </p>
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="schar-dira" title="שכר דירה לתקופת הביניים">
            ...
            <ul className="mt-2 space-y-3 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              <li>
                <strong className="text-[var(--color-primary)]">סכום שכר הדירה:</strong> נקבע בהסכם, מבוסס על שווי שכר דירה לדירה דומה בעיר. במרכז הארץ ב-2026, שכר דירה טיפוסי לדירת 4 חדרים נע בין 8,000 ל-12,000 ש״ח לחודש [טעון אימות].
              </li>
              <li>
              ...
              <li>
                <strong className="text-[var(--color-primary)]">מענק התקנה:</strong> בנוסף לשכר הדירה, חלק מההסכמים כוללים מענק חד-פעמי של 5,000 עד 15,000 ש״ח בעת המעבר, להוצאות התקנה ראשונית [טעון אימות].
              </li>
              <li>
            ...
            <p>
              בחישוב גס, ל-30 חודשי בנייה במרכז הארץ, היזם משלם 240,000 עד 360,000 ש״ח [טעון אימות] בשכר דירה לדייר אחד. בהסכם של 50 דיירים מדובר ב-12 עד 18 מיליון ש״ח שיוצאים מכיסי היזם לפני המסירה.
            </p>
          </ContentSection>
        </Reveal>
      </Section>
      ...
      <Section tone="white">
        <Reveal>
          <ContentSection id="masim" title="מסים: מי משלם, מה החריגים">
            ...
            <ul className="mt-2 space-y-3 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              <li>
                <strong className="text-[var(--color-primary)]">מס שבח:</strong> הדייר משלם, אך קיים פטור בפינוי בינוי בתנאי סעיף 49לג1 [טעון אימות לסעיף] לחוק מיסוי מקרקעין (שבח ורכישה). הפטור אינו אוטומטי וכפוף לעמידה בתנאים שמוגדרים בחוק.
              </li>
              <li>
              ...
              <li>
                <strong className="text-[var(--color-primary)]">נייר עמדה 03/2026, יורשים:</strong> רשות המסים פרסמה ב-03/2026 [טעון אימות לתאריך מדויק] נייר עמדה שמרחיב את הפטור גם ליורשי דירות במתחמי התחדשות עירונית. גם אחרי שהבניין נהרס, היורשים יכולים לקבל פטור ממס שבח. נייר העמדה הזה פתר את &ldquo;מלכוד היורשים&rdquo; שהיה קיים עד 2025.
              </li>
            </ul>
            <p className="font-bold text-[var(--color-primary)] mt-4">
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="chova" title="מה אסור לוותר עליו בהסכם">
            <p>
              שמונה סעיפים לא-ניתנים-לוויתור צריכים להופיע בכל הסכם פינוי בינוי תקני. אם היזם מסרב לאחד מהם, יש בעיה בעוד לפני החתימה. [טעון אימות לרשימה הספציפית — סקירת ניסיון חוזים]
            </p>
