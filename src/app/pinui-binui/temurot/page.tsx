...
const TITLE = "תמורות בפינוי בינוי 2026: כמה מטר מוסיפים, חניה, ומה הסטנדרט | התחדשות";
const DESCRIPTION =
  "תמורות בפינוי בינוי כוללות דירת תמורה גדולה ב-15 עד 35 מ״ר, חניה תת-קרקעית, מחסן, ולעיתים פיצוי כספי. מדריך 2026: מה לבדוק בהסכם, מה לדרוש, מה לא לוותר עליו.";
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8">
              ...
              בישראל נכון לשנת 2026 כוללת דירה חדשה במתחם, גדולה ב-15 עד 35 מ״ר מהדירה הישנה, חניה תת-קרקעית, מחסן, ולעיתים מרפסת או פיצוי כספי. הדייר אינו משלם דבר על התמורה, ועלויות המס משתנות בין הסכם להסכם. הטווח המדויק תלוי באזור הגיאוגרפי, בערך הקרקע, בכוח המיקוח של הדיירים, ובתשואת היזם. מדריך זה מפרט מה כולל סטנדרט תמורות, מה מעבר לסטנדרט, ומה אסור לוותר עליו בהסכם הפינוי.
            </p>
          </div>
        </Reveal>
      </Section>
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו לא יזמים. אנחנו חברת בנייה שמלווה נציגויות דיירים ובוחנת הצעות יזמים מבחינה מקצועית: מ״ר בפועל, חניה, מחסן, פיצוי כספי, וסעיפים שמרבים להחליק. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
