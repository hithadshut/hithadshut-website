...
const TITLE = "חוק 67% בפינוי בינוי 2026: רוב נדרש ודייר סרבן | התחדשות";
const DESCRIPTION =
  "חוק 67% מאפשר ליזם בפינוי בינוי לתבוע דייר סרבן בהסכמת 67% מהדיירים בלבד. מדריך 2026: מה זה אומר בפועל, איך זה משפיע עליכם ומה הדייר יכול לעשות.";
