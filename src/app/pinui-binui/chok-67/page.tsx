...
const TITLE = "חוק 67% בפינוי בינוי 2026: רוב נדרש, דייר סרבן, מה השתנה | התחדשות";
const DESCRIPTION =
  "חוק 67% מאפשר ליזם בפינוי בינוי לתבוע דייר סרבן בהסכמה של 67% מבעלי הדירות בלבד, במקום 80%. מדריך 2026: מה זה אומר בפועל, איך זה משפיע עליכם, ומה דייר סרבן יכול לעשות.";
        ...
        <Reveal>
          <div className="max-w-3xl">
            <p className="text-[17px] text-[var(--color-ink)] leading-8">
              חוק 67% הוא תיקון לחוק פינוי ובינוי (פיצויים) שהוריד את הרף הנדרש להגשת תביעה נגד דייר סרבן בפרויקט{" "}
              <Link
                href="/pinui-binui"
              ...
              מ-80% ל-67% (שני שלישים) מבעלי הדירות במתחם. התיקון הפך את פינוי בינוי למסלול הדומיננטי של התחדשות עירונית בישראל, אך לא ביטל את חובת ההסכמה של כל הדיירים בסופו של דבר. מדריך זה מסביר מה השתנה, מה לא השתנה, ואילו הגנות נותרו לדייר שמסרב.
            </p>
          </div>
        </Reveal>
      </Section>
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="hashpaot" title="השפעות חוק 67% על השוק">
            ...
            <ul className="mt-2 space-y-3 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              <li>
                <strong className="text-[var(--color-primary)]">יותר פרויקטים יוצאים לפועל:</strong> בשנים שלאחר התיקון, מספר פרויקטי פינוי בינוי שאושרו עלה משמעותית [טעון אימות לנתון מדויק].
              </li>
              <li>
              ...
              <li>
                <strong className="text-[var(--color-primary)]">יותר תביעות מוגשות, רובן נסגרות בהסדר:</strong> סטטיסטית, רוב תביעות הסרבנות לא מגיעות לפסק דין סופי [טעון אימות]. הצדדים מוצאים פתרונות בדרך, לרוב פיצוי כספי או שדרוג ההצעה.
              </li>
            </ul>
            <p className="text-sm text-[var(--color-muted)]">
              מקור רגולטורי:{" "}
