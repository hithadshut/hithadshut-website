...
const TITLE = "פינוי בינוי 2026: התהליך, הסיכונים וכמה זמן זה לוקח";
const DESCRIPTION =
  "פינוי בינוי 2026: איך התהליך עובד, מה הסיכונים המרכזיים, וכמה זמן זה באמת לוקח (7-12 שנים). רוב 67% נגד סרבן, תמורות, זכויות קשישים 70+/75+, ואפשרות מכירה.";
...
const faqs = [
  ...
  {
    q: "מה הסיכונים העיקריים בפינוי בינוי?",
    a: "ארבעה סיכונים מרכזיים: עיכובים תכנוניים בוועדה המקומית שלא תלויים בדיירים, כשל פיננסי של היזם באמצע הפרויקט, דייר סרבן שמעכב את ההליך גם אחרי 67% הסכמה, וירידת כדאיות כלכלית ליזם עם שינויי שוק. ערבויות בנקאיות מלאות לפי חוק המכר, ועורך דין דיירים בלתי תלוי, הם ההגנה המרכזית מול הסיכונים האלה.",
  },
  {
...
export default function Page() {
  return (
    <>
      <SchemaArticle
        headline="פינוי בינוי 2026: התהליך המלא, הסיכונים וכמה זמן זה באמת לוקח"
        description={DESCRIPTION}
        canonical={PATH}
      ...
      <PageHero
        ...
        title="פינוי בינוי 2026: התהליך המלא, הסיכונים וכמה זמן זה באמת לוקח"
        subtitle="כל מה שצריך לדעת על פינוי בינוי בישראל ב-2026: המסלול, חוק 67%, הסיכונים שכדאי להכיר מראש, והתמורות."
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-0">
                ...
                פרויקטים למסלול פינוי בינוי. מתחם פינוי בינוי דורש לפחות 24 יחידות דיור. לצד
                ההזדמנות יש גם סיכונים אמיתיים שכדאי להכיר לפני שמתחייבים: עיכובים תכנוניים
                שלא תלויים ביזם או בדיירים, יזם שלא עומד בהתחייבויותיו הפיננסיות, ודייר סרבן
                שמעכב את ההליך.
              </p>
            </div>
      ...
      <Section tone="soft">
        <Reveal>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <ContentSection level={3} id="sq-hascama" title="אחוז ההסכמה הנדרש">
              <p>
                אחוז ההסכמה הנדרש לפינוי בינוי הוא 67% מבעלי הדירות (שני שלישים) כדי להגיש
                תביעה נגד דייר סרבן, ירידה מ-80% לפי תיקון 2024. זהו רף להגשת תביעה בלבד, ולביצוע הפרויקט בפועל נדרשים
      ...
      <Section tone="white">
        <Reveal>
          <ContentSection id="chok-67" title="חוק 67%: אחוז ההסכמה הנדרש בפינוי בינוי">
            <p>
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="sikunim" title="הסיכונים בפינוי בינוי: מה יכול לעכב או לפגוע בפרויקט">
            <p>
              פינוי בינוי הוא הזדמנות אמיתית, אבל תהליך שאורך 7 עד 12 שנים נושא גם סיכונים
              אמיתיים. הכרת הסיכונים מראש, לא רק היתרונות, היא חלק מקבלת החלטה שקולה.
            </p>
            <ul className="mt-4 space-y-3 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              <li>
                <strong className="text-[var(--color-primary)]">עיכובים תכנוניים.</strong> השלב
                בוועדה המקומית תלוי בקצב הרשות, לא בדיירים או ביזם, ויכול להתארך הרבה מעבר
                לצפוי, במיוחד באזורים עם עומס תכנוני.
              </li>
              <li>
                <strong className="text-[var(--color-primary)]">כשל פיננסי של היזם.</strong> יזם
                שנקלע לקשיים באמצע הפרויקט עלול לעצור בנייה או לחדול מפעילות. זו הסיבה
                שהערבויות הבנקאיות לפי חוק המכר הן לא סעיף טכני אלא ההגנה המרכזית של הדיירים,
                כפי שמפורט במדריך{" "}
                <Link
                  href="/pinui-binui/eravut"
                  className="font-bold text-[var(--color-primary)] underline underline-offset-4 hover:text-[var(--color-accent-dark)]"
              ...
              <li>
                <strong className="text-[var(--color-primary)]">דייר סרבן שמעכב את ההליך.</strong>{" "}
                גם עם 67% הסכמה, סרבן יחיד יכול לעכב את הפרויקט בשנה עד שלוש שנים נוספות של
                הליך משפטי, כמפורט במדריך{" "}
                <Link
                  href="/pinui-binui/sarvan"
                  className="font-bold text-[var(--color-primary)] underline underline-offset-4 hover:text-[var(--color-accent-dark)]"
                >
              ...
              <li>
                <strong className="text-[var(--color-primary)]">ירידת כדאיות כלכלית ליזם.</strong>{" "}
                שינויים בשוק הנדל״ן, בעלויות הבנייה או בריבית עשויים להפוך פרויקט שהיה כדאי
                ליזם בתחילת הדרך לפחות כדאי באמצעה, מה שעלול להוביל לבקשות לשינויים בתנאי ההסכם
                או לעיכובים.
              </li>
              <li>
                <strong className="text-[var(--color-primary)]">אי-ודאות ממושכת לדיירים.</strong>{" "}
                תקופת הביניים, כולל המעבר לדיור חלופי, נמשכת שנים ולא חודשים. זו הסיבה שההסכם
                חייב לעגן מראש שכר דירה, פיצוי על איחור, ומועד מסירה מחייב, לא הבטחות בעל-פה.
              </li>
            </ul>
            <p className="mt-4">
              אף אחד מהסיכונים האלה אינו סיבה לוותר על פינוי בינוי כשהוא מתאים לבניין שלכם. הם
              סיבה לבחור יזם מסודר, לעגן ערבויות מלאות בהסכם, ולהיכנס לתהליך עם ציפיות ריאליות
              ללוח הזמנים.
            </p>
          </ContentSection>
        </Reveal>
        ...
        <Reveal>
          <ContentSection id="kdai" title="למה כדאי פינוי בינוי, וגם למה לא תמיד כדאי">
            ...
            <ul className="space-y-2 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              ...
              <li>
                הבניין שלכם בודד ולא חלק ממתחם של 24 יחידות. תמ״א 38/2 או חלופת שקד עשויות
                להתאים יותר. ובעלים של בניין שלם ששוקלים לוותר על מסלול התחדשות ולמכור ישירות
                יכולים לעיין ב
                <Link
                  href="/mechira/binyan-shalem"
                  className="font-bold text-[var(--color-primary)] underline underline-offset-4 hover:text-[var(--color-accent-dark)]"
                >
                  מדריך מכירת בניין שלם
                </Link>
                .
              </li>
