              ...
              rows={[
                {
                  ...
                  cells: {
                    ...
                    majority: "66%",
                    duration: "3–5 שנים",
                    fit: "בניינים שמסוגלים לעמוד בחיזוק; פוקעת מאי 2026 [טעון אימות]",
                  },
                },
                {
                  ...
                  cells: {
                    ...
                    majority: "80%",
                    duration: "5–8 שנים",
                    fit: "בניין יחיד שיוצא לו לבד; פוקעת מאי 2026 [טעון אימות]",
                  },
                },
                {
        ...
        <Reveal>
          <ContentSection id="chok-67" title="חוק 67%: מה זה אומר עליכם">
            ...
            <p className="text-sm text-[var(--color-muted)]">
              ...
              . הציטוט המדויק של תיקון מס&apos; ספציפי לחוק פינוי ובינוי (פיצויים) פתוח לאימות עם עורך דין מקרקעין [טעון אימות].
            </p>
          </ContentSection>
        </Reveal>
      </Section>
        ...
        <Reveal>
          <ContentSection id="kdai" title="למה כדאי פינוי בינוי, וגם למה לא תמיד כדאי">
            ...
            <ul className="space-y-2 list-disc pr-6 marker:text-[var(--color-accent-dark)]">
              <li>הבניין שלכם בן 40 שנה ומעלה, בלי ממ״ד דירתי, ואין סיכוי שיעבור חיזוק תמ״א 38 (כי היא פוקעת [טעון אימות]).</li>
