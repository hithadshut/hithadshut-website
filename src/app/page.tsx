...
const faqs = [
  ...
  {
    q: "איך מתחילים?",
    a: `שיחת ייעוץ ראשונה ללא עלות. אפשר להתקשר ל-${site.phone}, לשלוח וואטסאפ או להשאיר פרטים — נחזור תוך שעות ספורות עם מפגש סיור וייעוץ בבית שלכם.`,
  },
];
...
const whyUs = [
  ...
  },
  {
    ...
    title: "שקיפות מלאה",
    desc: "מחיר סופי בחוזה, לוח זמנים ברור, אחריות — בלי הפתעות.",
  },
];
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="hero-in hero-in-3 mt-7 text-lg md:text-xl text-white/85 max-w-2xl leading-relaxed">
              ...
              תכנון, ביצוע, אישורי פיקוד העורף — הכל אצלנו, תחת גג אחד.
            </p>
