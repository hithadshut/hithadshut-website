...
const whyUs = [
  {
    ...
    desc: "אנחנו מתכננים, מבצעים ומוסרים. חוזה אחד, אחריות אחת, צוות שלנו.",
  },
  {
    icon: "key" as const,
  ...
  },
  {
    ...
    desc: "קבלנים רשומים, מהנדסים ואדריכלים. צוות קבוע, לא משימה חד-פעמית.",
  },
  {
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="hero-in hero-in-3 mt-7 text-lg md:text-xl text-white/85 max-w-2xl leading-relaxed">
              חברת התחדשות בינוי ויזמות. בניית ממ״דים, מיגון חדרים וממ״ד מוכן לפי תקן פקע״ר, עם מהנדס קונסטרוקציה רשום.
          ...
          <Reveal>
            <div className="max-w-3xl mb-14">
              ...
              <p className="mt-4 text-lg text-[var(--color-muted)] max-w-2xl leading-relaxed">
                התחדשות מתמחה בבניית ממ״דים, מיגון חדרים וממ״ד מוכן. כל פרויקט מבוצע
