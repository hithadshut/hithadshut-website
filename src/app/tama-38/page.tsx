...
const PATH = "/tama-38";
const TITLE = "תמ״א 38 ב-2026: פוקעת, אלטרנטיבות, מה לעשות עכשיו | התחדשות";
const DESCRIPTION =
  "תמ״א 38 פוקעת במאי 2026 ברוב הארץ. מדריך מלא 2026: היסטוריה, ההבדל בין 38/1 ל-38/2, מצב הפרויקטים הקיימים, האלטרנטיבות (חלופת שקד, פינוי בינוי), ומה לעשות אם אתם בתוך פרויקט.";
