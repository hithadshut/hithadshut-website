...
const DESCRIPTION =
  "תמ״א 38/1: מסלול חיזוק בניין קיים בלי הריסה, בהסכמת 66% מהדיירים. מתי פג תוקף המסלול, מה ההבדל מתמ״א 38/2 ומפינוי בינוי, וזכויות הדיירים. מדריך מעודכן 2026.";
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו מלווים דיירים בבחינת מסלולי התחדשות. עובדים בשבילכם, לא בשביל היזם. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
