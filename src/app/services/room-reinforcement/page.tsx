...
const faqs = [
  ...
  {
    q: "צריך אישור פקע״ר?",
    a: "תלוי בהיקף. חיזוק קונסטרוקטיבי או החלפת דלת הדף: לרוב כן. החלפות קוסמטיות: לא. בודקים לפני שמתחילים ומטפלים בהיתרים הנדרשים. דרישות הרשויות המקומיות משתנות: חלק מהעיריות מחמירות יותר מאחרות, ולפעמים נדרש גם אישור של מחלקת ההנדסה המקומית על שינויים קונסטרוקטיביים. את הדרישות הספציפיות בעירייה שלכם אנחנו בודקים לפני שמתחילים.",
  },
  {
