...
const faqs = [
  ...
  {
    q: "האם שיפור מיגון מתאים לבית פרטי?",
    a: "כן. שיפור מיגון (חיזוק חדר קיים) הוא פתרון תקני לבית פרטי בכל אזורי הארץ, כולל מרכז וחוף, כשבניית ממ״ד חדש לא אפשרית. חשוב לא לבלבל בין זה לבין מיגונית: מיגונית היא יחידה נפרדת שפיקוד העורף מאשר בעיקר לאזורי גבול ולמתחמים ציבוריים, ואינה פתרון מוכר לבית פרטי במרכז הארץ. להשוואה מלאה בין שלושת הפתרונות ראו את ההשוואה שלנו.",
  },
];
    ...
    <ServicePageLayout
      ...
      quickAnswer={
        <>
          ...
          מממ״ד תקני (תקן 4422), אך גבוהה משמעותית מחדר רגיל. נדרש{" "}
          <Link href="/guides/home-front-command-approval" className="font-bold underline underline-offset-4">
            אישור פיקוד העורף
          </Link>{" "}
          לפני תחילת העבודות.
        </>
