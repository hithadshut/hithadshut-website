...
const TITLE = "מיגון חדר קיים — חברת התחדשות | בינוי ויזמות";
const DESCRIPTION =
  "מיגון חדר קיים — חיזוק קירות, תקרה, דלת וחלון לשיפור ההגנה. חברת התחדשות — בינוי ויזמות. ביצוע מקצועי, שקיפות מלאה, אחריות.";
...
const faqs = [
  ...
  {
    q: "מה כולל המיגון?",
    a: "תלוי בחדר: חיזוק קירות ותקרה, החלפת דלת לדלת חזקה או דלת הדף, החלפת חלון לחלון מוגן, אטימה, שיפור אוורור. כל מקרה נבחן בנפרד — אין 'מפרט אחיד'.",
  },
  {
    q: "כמה זמן זה לוקח?",
    a: "מיגון חלקי (דלת, חלון, אטימה) — שבועיים עד חודש. מיגון מלא עם חיזוק קונסטרוקטיבי — 1–2 חודשים [טעון אימות מקצועי].",
  },
  {
    q: "כמה זה עולה?",
    a: "טווח רחב — ממספר עשרות אלפי שקלים למיגון חלקי ועד 150,000 ₪ ויותר לחיזוק מלא עם קירות ותקרה [טעון אימות מקצועי]. אצלנו הצעת מחיר מפורטת לפי הרכיבים.",
  },
  {
    q: "צריך אישור פקע״ר?",
  ...
  {
    q: "יתרונות מול ממ״ד?",
    a: "זול יותר, מהיר יותר, פחות פולשני, לא דורש 'מקום' נוסף בבית. פתרון פרקטי כשממ״ד לא אפשרי.",
  },
  {
    q: "חסרונות?",
...
const subtypes = [
  { title: "מיגון חלקי", text: "החלפת דלת וחלון, אטימה בסיסית. מהיר ובעלות נמוכה יחסית — שיפור משמעותי בלי פרויקט גדול." },
  { title: "מיגון מלא", text: "חיזוק קירות ותקרה + דלת הדף + חלון תקני + אטימה ואוורור. מתקרב לרמת ממ״ד אך לא מקבל אישור פקע״ר." },
...
export default function Page() {
  return (
    <ServicePageLayout
      ...
      steps={steps}
      benefits={benefits}
      timeline="מיגון חלקי: 2–4 שבועות. מיגון מלא עם חיזוק קונסטרוקטיבי: 1–2 חודשים."
      pricing="מיגון חלקי (דלת+חלון+אטימה): 40,000–80,000 ₪. מיגון מלא עם חיזוק קירות ותקרה: 80,000–150,000 ₪. [טעון אימות מקצועי]"
      faqs={faqs}
