...
const faqs = [
  ...
  {
    q: "כמה זה עולה?",
    a: "100,000–180,000 ₪ לממ״ד טרומי תקני כולל הובלה, הנפה, יסוד וחיבורים [טעון אימות מקצועי]. קרוב למחיר ממ״ד יצוק באתר, לפעמים זול יותר, לפעמים יקר יותר — תלוי בדגם ובאתר.",
  },
  {
    q: "כמה זמן לוקח?",
...
export default function Page() {
  return (
    <ServicePageLayout
      ...
      pricing="ממ״ד טרומי תקני 9–12 מ״ר: 100,000–180,000 ₪ כולל הובלה, יסוד, חיבורים ואישור."
      faqs={faqs}
