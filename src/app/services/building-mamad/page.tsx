...
const faqs = [
  ...
  {
    q: "מה הגודל המינימלי?",
    a: "ממ״ד דירתי סטנדרטי: שטח של 9 מ״ר לפחות ונפח פנימי של 22.5 מ״ק. במקרים חריגים אפשר לאשר ממ״ד מוקטן מ-5 מ״ר.",
  },
  {
    q: "צריך היתר בנייה?",
...
const mamadTypes: MamadType[] = [
  ...
  },
  {
    ...
    priceImpact: "תוספת מחיר של 10%-30% מעל ממ״ד בקומת קרקע, בשל חיזוקים, מורכבות ביצוע ושינוע אנכי. טווח אופייני: 200,000-280,000 ₪ + מע״מ.",
  ...
  },
  {
    ...
    priceImpact: "תוספת של 25%-40% מעל ממ״ד עילי. בתנאי קרקע קשים או מי תהום גבוהים, עלויות יכולות להכפיל את מחיר הבסיס.",
    ...
    <ServicePageLayout
      ...
      intro={
        <>
          ...
          <p>
            ...
            של העסק שלנו. מתכנון ראשוני ועד מסירת מפתח עם תיק פרויקט מלא. גם התכנון האדריכלי ועריכת
            הבקשה להיתר נעשים אצלנו, ראו{" "}
            <Link href="/guides/architect-mamad-role" className="font-bold text-[var(--color-primary)] underline underline-offset-4 hover:text-[var(--color-accent-dark)]">
              תכנון אדריכלי ועריכת בקשה לממ״ד
            </Link>
            .
          </p>
          <p>
            במקרים שבהם הבניין שלכם נמצא במתחם של 24 יחידות דיור ומעלה, ייתכן שהמסלול הנכון
            אינו בניית ממ״ד דירתי, אלא תהליך{" "}
            <Link href="/pinui-binui" className="font-bold text-[var(--color-primary)] underline underline-offset-4 hover:text-[var(--color-accent-dark)]">
              פינוי בינוי
            </Link>{" "}
            שבו הבניין כולו נהרס ונבנה מחדש עם ממ״ד תקני בכל דירה.
          </p>
        </>
      }
      includes={includes}
      ...
      quickAnswer={
        <>
          ...
          ב<strong>מסלול הפטור (סעיף 30ב׳)</strong>, הוראת שעה בתוקף (בכפוף לעדכוני חקיקה)
          לבתים צמודי קרקע ולבניינים עד 2 קומות, התהליך 2-4 חודשים: תכנון, אישור פקע״ר עד 14 ימי עבודה,
          ביצוע 6-10 שבועות.
        </>
      }
    >
      <AnswerBlock
        service="בניית ממ״ד וקבלן ממ״ד תקני בכל הארץ"
        process="סיור ומדידה, תכנון, אישור פקע״ר, ביצוע ומסירה"
        answer={
          <>
            בניית ממ״ד היא יציקת חדר מבטון מזוין לפי תקן פיקוד העורף 4422 ותקן סינון אב״כ 4570,
            עם דלת הדף וחלון תקני. כקבלן ממ״ד הבונה בכל הארץ, התחדשות בינוי ויזמות מבצעת את כל
            הפרויקט בחוזה אחד: תכנון, רישוי, בנייה וגמר. ממ״ד צמוד, חיצוני, על הגג או תת-קרקעי,
            לפי מבנה הבית והזכויות הזמינות.
          </>
        }
        faqs={[
          {
            q: "מי בונה ממ״ד, קבלן רגיל או מומחה?",
            a: "ממ״ד הוא אלמנט קונסטרוקטיבי לפי תקן 4422, ולא כל קבלן או קונסטרוקטור מתמחה בו. חשוב לבחור קבלן רשום עם ניסיון ספציפי בממ״ד ובאישורי פיקוד העורף.",
          },
          {
            q: "מה כולל שירות בניית ממ״ד?",
            a: "תכנון אדריכלי וקונסטרוקטיבי, בחירת מסלול רישוי, הגשה לפיקוד העורף, יציקת בטון מזוין, התקנת דלת הדף, חלון ומערכת סינון, וגמר פנים מלא עד אישור גמר.",
          },
          {
            q: "כמה זמן לוקחת בניית ממ״ד?",
            a: "אישור פקע״ר עד 14 ימי עבודה במסלול פטור, וביצוע 6-10 שבועות לממ״ד סטנדרטי. סך הכל לרוב 2-4 חודשים.",
          },
          {
            q: "איפה אתם בונים ממ״ד?",
            a: "בכל הארץ. אנחנו מבצעים את הפרויקט מקצה לקצה, חברה אחת ואחריות אחת, בבית פרטי או בדירה.",
          },
        ]}
      />
            ...
            <Reveal>
              ...
              >
                ...
                <p className="text-sm text-[var(--color-ink)] leading-relaxed">
                  ...
                  <strong>15,000-25,000 ₪</strong>. הוראת שעה בתוקף לבתים צמודי קרקע
                  ולבניינים עד 2 קומות (מועד הסיום בכפוף לעדכוני חקיקה, יש לאמת באתר מינהל התכנון).
                  אם הקבלן שלכם לא מציע את המסלול הזה, שאלו למה.
                </p>
              </article>
            </Reveal>
          </div>
