...
const faqs = [
  ...
  },
  {
    ...
    a: "מיגונית תקנית חייבת פתח אוורור מוגן. סינון כימי-ביולוגי בסיסי נכלל בחלק מהדגמים, אבל לא בכולם. חשוב לבדוק מפרט כל דגם לפני הזמנה. מערכת סינון NBC מתקדמת (דומה לזו שיש בממ״ד תקני) זמינה בדגמים מתקדמים בתוספת של 8,000-18,000 ₪. אצלנו מפרטים בכתב איזה רכיבי סינון כלולים בכל דגם מוצע.",
  },
  {
  ...
  {
    q: "מה התחזוקה הנדרשת?",
    a: "המיגונית עצמה (הבטון והקונסטרוקציה) כמעט ולא דורשת תחזוקה. מה שכן צריך טיפול: בדיקה שנתית של דלת הדף (אטימה, צירים, מנגנון נעילה), החלפת פילטרי סינון לפי הוראות היצרן (בדרך כלל כל 5-10 שנים), בדיקת פתחי אוורור ומאווררים, ניקוי פנימי תקופתי. מומלצת בדיקה מקצועית אחת לשנה-שנתיים.",
  },
  {
...
const sizeRows: SizeRow[] = [
  { occupants: "2 אנשים", dimensions: "~1.6×1.6 מ׳ (2.5 מ״ר)", price: "25,000-40,000 ₪ + מע״מ", install: "יום עבודה להצבה" },
  ...
  { occupants: "8+ אנשים", dimensions: "~3.0×3.0 מ׳ (9 מ״ר)", price: "65,000-100,000 ₪ + מע״מ", install: "יום-יומיים להצבה" },
];
