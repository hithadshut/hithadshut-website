...
const TITLE = "ממ״ד בבניין משותף 2026: דירתי או משותף | התחדשות";
const DESCRIPTION =
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו חברת בנייה. תכנון, היתרים, ביצוע, הכל אצלנו. מלווים ועדי בית בפרויקטי ממ״ד משותפים: השוואת אפשרויות, חלוקת עלויות וביצוע מקצועי. חוזה אחד, אחריות אחת. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
