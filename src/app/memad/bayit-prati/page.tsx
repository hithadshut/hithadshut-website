...
const DESCRIPTION =
  "ממ״ד לבית פרטי 2026: צמוד, חיצוני, על הגג או תת-קרקעי. עלויות 160,000-280,000 ש״ח. מסלול פטור מהיתר במסגרת חרבות ברזל. מדריך מלא לאפשרויות וההליך.";
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו חברת בנייה. תכנון, היתרים, ביצוע, הכל אצלנו. מבצעים ממ״דים בבתים פרטיים בכל הארץ, מהתכנון ועד מסירת המפתח. חוזה אחד, אחריות אחת, צוות אחד. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
