...
const DESCRIPTION =
  "ממ״ד בדירה בקומה דורש חישוב קונסטרוקטיבי, אישור ועדה ולעיתים הסכמת שכנים. עלות גבוהה ב-30%-50% מבית פרטי. מדריך 2026 לפתרונות ובחירה נכונה.";
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו חברת בנייה. תכנון, היתרים, ביצוע, הכל אצלנו. מתמחים בממ״דים מורכבים בדירות בקומה ובשיפור מיגון. חוזה אחד, אחריות אחת, צוות אחד עד מסירת המפתחות. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
