...
const DESCRIPTION =
  "ממ״ד בקומה עליונה לדירות גג ופנטהאוזים: חיזוק מבנה ומשאבת בטון. עלות 200,000-280,000 ש״ח. מדריך 2026: מתי מתאים, איך עושים ומה האלטרנטיבות.";
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו חברת בנייה. תכנון, היתרים, ביצוע, הכל אצלנו. מבצעים ממ״דים בקומות עליונות, כולל בדירות גג ופנטהאוזים. חוזה אחד, אחריות אחת, צוות אחד עד מסירת המפתחות. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
