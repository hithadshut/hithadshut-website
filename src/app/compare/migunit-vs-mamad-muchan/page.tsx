...
const options: Option[] = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        value:
          "יחידה גלויה בחצר, נראית כמבנה עצמאי (קונטיינר מיגון). אפשר לחפות / לצבוע כדי להשתלב.",
      },
      {
        label: "מתי מתאים",
        value:
...
const faqs = [
  ...
  },
  {
    ...
    a: "מיגונית מאושרת פקע״ר היא פתרון לגיטימי למבנה קטן, מוסד חינוכי או תוספת לבית עם חצר. היא פחות מתאימה לבית פרטי שבו משפחה צריכה להיכנס למרחב מוגן תוך שניות, ושם מיגון חדר קיים יהיה פרקטי יותר. הבחירה תלויה בזמני ההתרעה ובהרכב המשפחה, לא רק בתקציב.",
  },
  {
