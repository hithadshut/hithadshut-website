...
const faqs = [
  ...
  },
  {
    ...
    a: "מיגונית מאושרת פקע״ר מתאימה לבית עם חצר וגישה טובה, כי היא מספקת רמת הגנה תקנית במחיר נמוך יותר. מיגון חדר קיים עדיף פרקטית כשאין מקום בחצר או כשיש במשפחה מישהו שלא יכול לצאת מהר בחירום, גם אם רמת ההגנה נמוכה יותר מתקן ממ\"ד. הבחירה תלויה בזמני ההתרעה באזור ובהרכב המשפחה.",
  },
  {
    q: "מה ההבדל בין ממ״ד יצוק לממ״ד מוכן (טרומי)?",
    a: "שניהם ממ״דים תקניים עם אישור פקע״ר. ממ״ד יצוק נבנה באתר, עם גמישות מלאה במידות ובשילוב עם הבית. ממ״ד מוכן (טרומי) מיוצר במפעל ומותקן בבית, מהיר יותר ועם פחות בלגן, אבל במידות קבועות.",
  },
  {
    q: "מיגונית במקום ממ״ד, זה כדאי?",
    a: "ממ״ד עדיף כמעט תמיד כשהוא אפשרי. הפער המרכזי: בממ״ד נכנסים מהבית פנימה תוך שניות, במיגונית צריך לצאת החוצה. באזורי קו קדמי שבהם זמני ההתרעה קצרים, ממ״ד משמעותית עדיף. ממ״ד גם משמש חדר ביום-יום. מיגונית היא הפתרון הנכון כשממ״ד אינו אפשרי מבחינה מבנית או תקציבית.",
  },
  {
