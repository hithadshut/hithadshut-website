...
const faqs = [
  {
    ...
    a: "לא במסלול פתרון פרטי תקני. במרכז הארץ הפתרון הפרטי המוכר על ידי פיקוד העורף הוא ממ״ד תקני (יצוק או יביל מאושר), או שיפור מיגון לחדר קיים כשממ״ד אינו אפשרי. מיגונית מסווגת בהנחיות פקע״ר כפתרון לאזורי גבול ולמרחב הציבורי, לא כתחליף לממ״ד דירתי. [טעון אימות מקצועי]",
  },
  {
  ...
  },
  {
    ...
    a: "באזורי גבול וביישובים מסוימים בקרבת רצועה או הצפון, פיקוד העורף מאשר מיגוניות כפתרון מיגון משלים, בעיקר במרחב ציבורי (גנים, מתחמי קהילה) ובמקרים פרטניים. גם שם, ממ״ד תקני נשאר הפתרון העדיף לבית פרטי. ההכרעה לגבי מיקום ספציפי דורשת בדיקה מול פיקוד העורף האזורי. [טעון אימות מקצועי]",
  },
  {
      ...
      <Section>
        ...
        <div className="mt-14 max-w-3xl">
          ...
          <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-4">
            מיגונית היא יחידת מיגון מתועשת, לרוב טרומית, שפיקוד העורף מאשר בעיקר לאזורי גבול, למתחמים ציבוריים, לגנים ולסביבות קהילתיות שבהן צריך לפרוס פתרון מהיר באזור פתוח. מבחינת הסיווג, היא לא מוגדרת כמרחב מוגן דירתי תקני לבית פרטי במרכז הארץ, וזה לא עניין של ניסוח אלא של הבדל מהותי באישורים, בעובי הקירות, בדרישות התקרה ובתקני הדלת. [טעון אימות מקצועי]
          </p>
          <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-4">
        ...
        <div className="mt-14 max-w-3xl">
          ...
          <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-4">
            מיגוניות מאושרות פקע״ר משמשות לעיתים באזורים אלה כתוספת מיגון ציבורי בתחנות אוטובוס, גני שעשועים ומתחמים קהילתיים, ולא כתחליף לממ״ד פרטי. גם בישוב גבול, אם בית פרטי שואל פתרון, ההמלצה לרוב היא ממ״ד תקני יצוק או יביל מאושר. [טעון אימות מקצועי]
          </p>
          <p className="text-[17px] text-[var(--color-ink)] leading-8">
