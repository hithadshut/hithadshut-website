...
const faqs = [
  ...
  },
  {
    ...
    a: "ממ״ד הוא סיווג פורמלי של פיקוד העורף — מרחב מוגן דירתי לפי תקן 4422, עם דרישות מפורשות לעובי קירות, דלת הדף, חלון, ומערכת אוורור וסינון. ״חמ״ד״ אינו סיווג פורמלי. אם הצעה מציגה ״חמ״ד״ ולא מציינת את תקן 4422 ואת אישור פיקוד העורף לכתובת — מדובר ככל הנראה בשיפור מיגון של חדר קיים, לא בממ״ד תקני.",
  },
  {
  ...
  {
    q: "כמה עולה חמ״ד?",
    a: "המחיר תלוי במה שבאמת מציעים: ממ״ד תקני 160,000-220,000 ₪ + מע״מ; שיפור מיגון 50,000-120,000 ₪ + מע״מ; ממ״ד יביל 90,000-130,000 ₪ + עלויות הובלה והכנת תשתית. פערים בהצעת מחיר ל״חמ״ד״ ללא ציון התקן והסיווג הם דגל אדום — לרוב הם מסתירים את ההבדל בין שיפור מיגון לבין ממ״ד תקני.",
  },
  {
    q: "מי מאשר חמ״ד?",
            ...
            <Reveal>
              ...
              >
                ...
                <p className="text-sm text-[var(--color-ink)] leading-relaxed">
                  ...
                  מספר האישור הצפוי? תשובה ברורה לארבעתם בכתב — ההצעה תקנית.
      ...
      <Section tone="white">
        <div className="max-w-3xl mx-auto prose prose-headings:text-[var(--color-primary)] prose-p:text-[17px] prose-p:leading-8 prose-p:text-[var(--color-ink)]">
          ...
          <p>
            ...
            לגיטימיים בנסיבות הנכונות; ערבוב הסיווגים — אינו.
          </p>
