...
const options: Option[] = [
  {
    ...
    rows: [
      ...
      {
        label: "זמן ביצוע",
        value: "2–4 חודשים בממוצע, כולל תכנון, אישור פקע״ר וביצוע בפועל.",
      },
      {
        label: "רישוי",
...
const callouts = [
  {
    ...
    text: "בממ״ד צמוד מגיעים תוך שניות מהחדרים המרכזיים. בממ״ד חיצוני צריך לצאת מהבית — זה יכול להיות הפרש של עשרות שניות, קריטי באזורים עם התרעה קצרה.",
  },
  {
  ...
  },
  {
    ...
    text: "ממ״ד חיצוני דורש יסוד עצמאי, קירות חיצוניים מלאים ולעיתים היתר בנייה מלא — ולכן יקר ב-15%–25% מממ״ד צמוד באותו גודל.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "ממ״ד צמוד — לרוב מסלול פטור מהיתר או היתר מקוצר לפי תקנות המקלטים, במקרים של תוספת עד 12 מ״ר. ממ״ד חיצוני — לרוב מחייב מסלול היתר מלא מהוועדה המקומית, כולל בדיקת קווי בניין, זכויות ואישור תכנוני. [טעון אימות מקצועי לפי רשות מקומית ותכנית מתאר ספציפית].",
  },
  {
  ...
  },
  {
    ...
    a: "לרוב כן, אבל לא תמיד. אם יש קיר נושא שצריך לחזק, או שהוועדה דורשת חישוב סטטי מחודש לכל הבית — ממ״ד צמוד יכול להתייקר. אצלנו כל פרויקט נבחן פרטנית עם מהנדס קונסטרוקציה — לפני שמתחייבים למסלול, אנחנו מציגים את העלות הריאלית לשני הפתרונות.",
  },
  {
