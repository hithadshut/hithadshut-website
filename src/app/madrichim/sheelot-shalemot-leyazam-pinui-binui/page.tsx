        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-6">
              אנחנו לא יזמים. אנחנו חברת בנייה שעוזרת לנציגויות דיירים לבדוק יזמים אחרים. ייעוץ ראשוני ללא עלות, ללא התחייבות.
            </p>
          </div>
          <InlineLeadForm
