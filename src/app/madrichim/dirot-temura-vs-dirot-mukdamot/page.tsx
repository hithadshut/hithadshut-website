...
const faqs = [
  ...
  },
  {
    ...
    a: "ארבעה: (1) ודאות, כלומר הדירה כבר קיימת, לא תלויה בהשלמת הפרויקט. (2) מהירות: הדייר עובר תוך 30-90 ימים, לא 7-12 שנים. (3) ניידות: אפשרות לבחור אזור חדש (למשל קרוב לילדים). (4) פתרון לאוכלוסיות עם אילוצים, כגון קשישים, חולים, בעלי מוגבלות. החיסרון העיקרי: ויתור על פוטנציאל הערכה של הדירה החדשה.",
  },
  {
          ...
          <div className="max-w-3xl">
            ...
            <div className="rounded-2xl border-2 border-[var(--color-accent)]/30 bg-[var(--color-soft)] p-6 md:p-7 mb-6">
              ...
              <p className="text-[17px] text-[var(--color-ink)] leading-8 m-0">
                <strong>בפינוי בינוי, בעלי דירה יכולים לקבל אחד משני מודלי תמורה:</strong> דירת תמורה, כלומר הדירה החדשה שתיבנה במתחם המחודש, מוסרת בסוף הפרויקט (7-12 שנים). דירה מוקדמת, כלומר דירה קיימת שהיזם רוכש מיד תמורת זכויות הדייר במתחם, מסירה תוך 30-90 ימים. דירת תמורה היא ברירת המחדל ובדרך כלל שווה יותר כספית. דירה מוקדמת מתאימה לקשישים מעל 70 (זכות לפי תיקון 80), ליורשים, ולבעלי אילוצים בריאותיים. ההפרש הכספי הממוצע: 15-30% לטובת דירת תמורה.
              </p>
            </div>
