        ...
        <Reveal>
          <ContentSection id="prakim-10-12" title="פרקים 10-12: הפרה, הוראות כלליות, נספחים">
            <ol start={10} className="mt-4 space-y-4 list-decimal pr-6 marker:font-bold marker:text-[var(--color-accent-dark)]">
              <li>
                <strong className="text-[var(--color-primary)]">פרק 10: הפרת חוזה (3-7 עמודים).</strong> מגדיר מה נחשב הפרה (איחור, אי-תשלום, אי-עמידה בסטנדרט), ומה הסעדים. מה לבדוק: סעדים סימטריים — היזם והדיירים זוכים לפיצוי דומה במקרה של הפרה הדדית.
              </li>
              <li>
