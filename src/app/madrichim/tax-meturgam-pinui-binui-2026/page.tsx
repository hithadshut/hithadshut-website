...
const faqs = [
  {
    ...
    a: "ברוב המקרים לא. רשות המסים מתייחסת לפינוי בינוי כעסקה רעיונית: בעל דירה לא מוכר ולא קונה בפועל, אלא מקבל דירה חדשה במקום הישנה. נייר עמדה של רשות המסים (mst-2026/03) מאשר שאין אירוע מס במעמד החתימה ובמעמד המסירה ברוב הפרויקטים. יוצאים מהכלל קיימים, ונדרשת התייעצות עם עורך דין מקרקעין או רואה חשבון לכל מקרה ספציפי.",
  },
  {
  ...
  },
  {
    ...
    a: "נושא רגיש. נייר עמדה של רשות המסים מ-03/2026 מאשר: יורשים שירשו דירה ועוברים פינוי בינוי במהלך הפרויקט שומרים על הפטור ממס שבח. הזכויות המקוריות של המוריש מועברות אליהם. אם המוריש היה זכאי לפטור, גם היורש זכאי לאותו פטור. ראו את המדריך על ירושה דירה בפינוי בינוי לפרטים מלאים.",
  },
  {
      ...
      <Section tone="white">
        <Reveal>
          <ContentSection id="mas-shevach" title="מס שבח: הקריטי ביותר">
            ...
            <p>
              <strong className="text-[var(--color-primary)]">חישוב מס במקרה שאין פטור:</strong> 25% מהשבח לדירת מגורים שאינה יחידה. מדרג עולה לפי שווי. החישוב מסובך, ונדרש רואה חשבון מנוסה. הוצאות עורך דין, שיפוצים, ועלויות עיסקה מותרות בקיזוז.
            </p>
            <p>
      ...
      <Section tone="soft">
        <Reveal>
          <ContentSection id="mas-rechisha" title="מס רכישה: כמעט תמיד פטור">
            ...
            <p>
              <strong className="text-[var(--color-primary)]">חישוב פטור:</strong> סעיף 9 לחוק מס רכישה קובע שהדירה החליפית בפינוי בינוי לא חייבת במס רכישה. במקרה של תוספת שטח, ייתכן ויחול מס רכישה רק על השווי המוסף. עד 50 מ״ר תוספת, רוב המקרים פטורים מתחת לסף. מעבר לזה נדרשת בדיקה ספציפית.
            </p>
            <p>
      ...
      <Section tone="white">
        <Reveal>
          <ContentSection id="mas-hachnasa" title="מס הכנסה: רק על שכר דירה חלופי">
            ...
            <p>
              <strong className="text-[var(--color-primary)]">תקבולים שחייבים במס הכנסה:</strong> שכר דירה חלופי שהיזם משלם לדייר על דירה ששוכר במקום אחר. ההכנסה הזו נחשבת הכנסה רגילה לעניין מס הכנסה. סף הכנסה משכר דירה משתחרר ממס נמצא בכ-5,471 ש״ח לחודש (2026). מעל הסף חלה חבות מס של 10% עד שיעור שולי גבוה יותר.
            </p>
          </ContentSection>
        </Reveal>
      </Section>
