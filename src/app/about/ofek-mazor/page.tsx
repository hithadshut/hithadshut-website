          ...
          <div>
            <Prose>
              ...
              <p>
                ...
                הפיזי של המשפחה ועל שווי הנכס. ההשקעה לממ״ד תקני נעה בטווח
                של {formatPriceRange(PRICING.mamadStandard)}, ולשיפור מיגון
                של חדר קיים בטווח של {formatPriceRange(PRICING.migunImprovement)}.
                באסימון כזה, אנשים שואלים בצדק: מי האדם שעומד מאחורי
                החברה, ומה האחריות האישית שלו על העבודה.
              </p>
              <p>
