    ...
    <>
      ...
      <Section>
        <Prose>
          ...
          <h2>תפקיד שלנו בתהליך</h2>
          <p>
            אנחנו לא הקבלן ולא האדריכל. אנחנו ה&quot;מנהל האישי&quot; של הלקוח — מי שמבין את התהליך כולו,
            יודע לזהות סיכונים, ונמצא בצד שלכם כששואלים &quot;מה הדבר הבא?&quot;. קראו גם{" "}
