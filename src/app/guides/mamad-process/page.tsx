...
const faqs = [
  ...
  },
  {
    ...
    a: "בבתים עד 2 קומות ובכפוף לתנאים שקבועים בתקנות התכנון והבנייה, במקרים רבים אפשר לבנות ממ\"ד במסלול פטור, המבוסס על אישור פיקוד העורף, הצהרת עורך הבקשה (אדריכל/מהנדס) והגשת הודעה בסיום. כל מקרה לגופו. יש לבדוק מראש.",
  },
  {
