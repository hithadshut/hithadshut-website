...
const faqs = [
  ...
  {
    q: "מה הקשר בין אישור פיקוד העורף לטופס 4?",
    a: "טופס 4 (אישור אכלוס) מותנה בכך שהמיגון עומד בדרישות פיקוד העורף. מאז 2024, מערכת אוורור וסינון אב\"כ לפי תקן 4570 היא חובה לטופס 4. לכן יש להשלים את אישור פיקוד העורף ואת המערכות התקניות לפני קבלת טופס 4.",
  },
  {
    q: "מהן הדרישות של פיקוד העורף לממ\"ד?",
    a: "הדרישות העיקריות לאישור: שטח מינימלי כ-9 מ\"ר לממ\"ד דירתי (5 מ\"ר במקרים חריגים), נפח פנימי כ-22.5 מ\"ק, דלת וחלון הדף לפי תקן 4570, חישוב קונסטרוקטיבי לפי תקן 4422 לממ\"ד, ומערכת אוורור וסינון אב\"כ מאושרת. פיקוד העורף בודק שכל אלה מתקיימים לפני האישור.",
  },
  {
    q: "האם מגישים את הבקשה לפיקוד העורף באופן מקוון?",
    a: "כן. הבקשה מוגשת אלקטרונית במערכת הרישוי המקוונת של פיקוד העורף (rishuy.org.il). הגשה מקוונת ומסודרת מקצרת את זמן האישור לכ-14 ימי עבודה, לעומת 30 ימים ומעלה בהגשה ידנית. לתיק שלם ומסודר התשובה מגיעה לעיתים תוך 7 עד 10 ימים.",
  },
  {
    q: "מה מספר הטלפון של פיקוד העורף לאישור ממ״ד?",
    a: "אין קו טלפון מרכזי אחד לכל הארץ. פיקוד העורף מפרסם טלפונים ושעות קבלת קהל נפרדים לכל מחוז (מרכז, צפון, דרום, ירושלים) בעמוד יצירת הקשר הרשמי שלו באתר oref.org.il. מומלץ לבדוק שם את הפרטים העדכניים לפי המחוז הרלוונטי, מכיוון שהם עשויים להשתנות. הערוץ המרכזי לטיפול בבקשה עצמה הוא מערכת הרישוי המקוונת בכתובת oref-rishuy.org.il, לא טלפון.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title="אישור פיקוד העורף והוצאת היתר לממ״ד"
      ...
      <Section>
        <div className="grid lg:grid-cols-[minmax(0,1fr)_280px] gap-10">
          <Prose>
          <h2 id="who-needs-it">מי צריך אישור פיקוד העורף</h2>
          <p>
            כל מי שבונה ממ״ד חדש, מרחיב ממ״ד קיים, מציב ממ״ד יביל, או מבצע מיגון של חדר קיים חייב
            באישור פיקוד העורף, בלי קשר לגודל הבית או לסוג המסלול (פטור מהיתר, רישוי מקוצר או רישוי
            רגיל). האישור נדרש הן לבתים פרטיים והן לדירות בבניינים משותפים. את הבקשה מגיש עורך הבקשה,
            אדריכל או מהנדס מורשה מטעם בעל הנכס, ולא בעל הנכס בעצמו ולא הקבלן.
          </p>
          ...
          <p>
            ...
            . שם מגיש עורך הבקשה את התיק, עוקב אחר הסטטוס, ומקבל את תשובת פקע״ר. אין קו טלפון
            מרכזי אחד לכל הארץ: פיקוד העורף מפרסם טלפונים ושעות קבלת קהל לפי מחוז (מרכז, צפון,
            דרום, ירושלים) בעמוד יצירת הקשר הרשמי שלו. מאחר שפרטי הקשר עשויים להתעדכן, יש לבדוק
            את המספר והשעות העדכניים ישירות בעמוד{" "}
            <a
              href="https://www.oref.org.il/heb/contact-page/"
              target="_blank"
              rel="noopener noreferrer"
              className="underline decoration-[var(--color-accent)] underline-offset-4 hover:text-[var(--color-accent-dark)]"
            >
              יצירת קשר של פיקוד העורף (oref.org.il)
            </a>
            {" "}לפי המחוז הרלוונטי לכתובת הנכס. עורך הבקשה שמלווה את התהליך שלכם אמור לדעת לאיזה
            מחוז לפנות ולוודא שהתיק שהוגש דרך המערכת המקוונת אכן התקבל לטיפול.
          </p>
      ...
      {/* Track B GEO/entity layer: company-managed process answer (no individual professional named;
          authority-intake.json has no verified named engineer/architect, so only company-level facts). */}
      <AnswerBlock
        id="who-executes"
        title="מי מבצע את התהליך"
        service="ניהול תהליך אישור פיקוד העורף לממ״ד תחת חוזה אחד"
        process="תיאום עורך הבקשה והחתימה ההנדסית, הגשה, מענה להערות ומעקב עד האישור"
        answer={
          <>
            בפרויקט שמנוהל על ידינו, התחדשות בינוי ויזמות מנהלת את תהליך אישור פיקוד העורף מקצה
            לקצה תחת חוזה אחד: בחירת מסלול הרישוי, הכנת תיק ההגשה, ההגשה האלקטרונית למערכת הרישוי,
            מענה להערות ומעקב עד קבלת האישור. את חתימת עורך הבקשה והחישוב ההנדסי הנדרשים בחוק אנחנו
            מתאמים כחלק מהתהליך המנוהל.
          </>
        }
        faqs={[
          {
            q: "האם צריך אדריכל או מהנדס בנפרד כדי לקבל אישור פיקוד העורף לממ״ד?",
            a: "כן. החתימה על הבקשה והחישוב הסטטי נדרשים מעורך בקשה מוסמך, אדריכל או מהנדס בניין, ומקונסטרוקטור, וזו דרישת חובה לאישור פיקוד העורף. אינכם צריכים לאתר ולתאם אותם בעצמכם: בפרויקט שמנוהל על ידינו אנחנו מתאמים את עורך הבקשה ואת החתימה ההנדסית כחלק מהשירות, כך שתהליך האישור מטופל ברצף אחד.",
          },
        ]}
      />
