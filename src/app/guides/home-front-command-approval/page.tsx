...
const TITLE = "אישור פיקוד העורף לממ״ד: תהליך מלא + לוח זמנים | מדריך 2026";
const DESCRIPTION =
  "אישור פיקוד העורף לממ״ד תקני: 14 ימי תשובה במסלול פטור, או עד 45 ימים במסלול רגיל. מסמכים נדרשים, שלבים מהתכנון ועד האישור, וטעויות נפוצות שמעכבות חודשים.";
      ...
      <Section>
        <div className="grid lg:grid-cols-[minmax(0,1fr)_280px] gap-10">
          ...
          <p>
            ...
            ההדף. הוראת השעה התקפה עד <strong>25.10.2026</strong> פוטרת בתים צמודי
            קרקע ובניינים עד 2 קומות מהיתר בנייה רגיל ומקצרת באופן משמעותי את הליך
            הרישוי. מאז 2024 מערכת אוורור וסינון אב״כ לפי תקן 4570 היא חובה לטופס 4.
          </p>
