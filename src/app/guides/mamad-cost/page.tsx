...
const faqs = [
  ...
  },
  {
    ...
    a: "לפעמים, במקרים חריגים, בעיקר לאזורי קו קדמי או לאחר אירועים ביטחוניים גדולים. בתקופות כאלה התקבלו הסדרים, הקלות רגולטוריות או מענקים מוגבלים לאזורים מסוימים. התנאים משתנים: יש לבדוק מול משרד הביטחון, משרד הפנים, רשויות מקומיות ופיקוד העורף. הכללים מתעדכנים. [טעון אימות מקצועי]",
  },
  {
          ...
          <div>
            ...
            <Prose>
              ...
              <ol>
                ...
                <li>
                  <strong>רמת הגמר.</strong> טיח, צבע וריצוף בסיסיים לעומת ריצוף פורצלן גדול, קירות מעוצבים, ספוטים שקועים ומזגן מרכזי, כאשר ההפרש מגיע לעשרות אלפי ₪.
                </li>
                <li>
              ...
              <p>
                יסודות, יציקת בטון מזוין לקירות, לתקרה ולרצפה. זיון פלדה לפי חישוב קונסטרוקטור. תבניות, משאבת בטון, עבודת זיון ויציקה. זה החלק הכבד של התקציב, ועל זה לא חוסכים. בטון באיכות נמוכה או זיון חסר: סכנה אמיתית.
              </p>
              <h3>2. דלת הדף וחלון ממ״ד (8%-15% מהתקציב)</h3>
              <p>
                דלת הדף תקנית: 12,000-25,000 ₪ לדלת רגילה; 25,000-45,000 ₪ לדגמים פרמיום [טעון אימות מקצועי]. חלון ממ״ד: 5,000-15,000 ₪ לחלון סטנדרטי. יש יצרנים מובילים כמו שחם, רב-בריח, ראב, כרמל מיגון, עם אישור פקע״ר לכל דגם.
              </p>
