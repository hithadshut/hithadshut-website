...
const DESCRIPTION =
  "ממ״ד תקני בית פרטי: 160,000-220,000 ש״ח. ממ״ד יביל unit-only: 90,000-130,000. יביל all-in: 180,000-250,000. שיפור מיגון: 120,000-150,000. בצפון עד 132,000 ש״ח סבסוד מדינה. פירוט לפי תרחיש.";
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-[17px] text-[var(--color-ink)] leading-8 mb-0">
              ...
              שיפור מיגון לחדר קיים: 120,000-150,000 ש״ח. ביישובי קו ראשון בצפון (1-5 ק״מ מהגבול),
          ...
          <div>
            ...
            <Prose>
              ...
              <ul>
                ...
                <li>
                  <strong>מיגון חדר קיים:</strong> 120,000-150,000 ₪ + מע״מ. שיפור הגנה ניכר אבל <em>לא</em> אישור ממ״ד תקני. זמן: 2-8 שבועות.
                </li>
                <li>
