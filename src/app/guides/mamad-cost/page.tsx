...
const faqs = [
  ...
  },
  {
    ...
    a: "לפעמים, במקרים חריגים, בעיקר לאזורי קו קדמי או לאחר אירועים ביטחוניים גדולים. בתקופות כאלה התקבלו הסדרים, הקלות רגולטוריות או מענקים מוגבלים לאזורים מסוימים. התנאים משתנים: יש לבדוק מול משרד הביטחון, משרד הפנים, רשויות מקומיות ופיקוד העורף. הכללים מתעדכנים.",
  },
  {
  ...
  },
  {
    ...
    a: "ממ״ד בדירה בקומה הוא פרויקט מורכב יותר: יש לטפל בהגבהת מעלית עמסים לחומר, הגנה על שכנים, חיזוק רצפה. הטווח לרוב 200,000-260,000 ₪ + מע״מ, בהתאם לגישה, קומה וסוג הבניין. כל פרויקט נבדק פרטנית.",
  },
];
