...
const TITLE = "איך בוחרים קבלן ממ״ד — רשימת בדיקה מלאה";
const DESCRIPTION =
  "בחירת קבלן ממ\"ד: מה לבדוק, שאלות לשאול, דגלים אדומים, רישיון קבלני, ביטוח ואחריות. לא ליפול על קבלן שלא יודע לבנות ממ\"ד.";
...
const faqs = [
  {
    ...
    a: "ממ\"ד הוא עבודת בנייה מיוחדת. הקבלן צריך להיות רשום בפנקס הקבלנים עם סיווג מתאים לגודל ולסוג העבודה. לבית פרטי לרוב סיווג 100 (בנייה) קטן מספיק, אך יש לבדוק בהתאם להיקף הכספי של הפרויקט [טעון אימות מקצועי].",
  },
  {
  ...
  },
  {
    ...
    a: "תיאור עבודות מפורט, מפרט טכני מלא, תכניות כנספחים, לוחות זמנים, אבני דרך לתשלום קשורות לביצוע, תוספות בכתב בלבד, אחריות (סוג והיקף), ביטוח קבלן ועבודות, סנקציות על איחור, תנאי הפסקת חוזה. חוזה באורך עמוד — סימן אדום.",
  },
  {
    q: "מה המחיר הסביר למקדמה?",
    a: "מקדמה מקובלת היא 5–15% מהסכום הכולל. כל מקדמה מעל 20% לפני תחילת עבודה בפועל — סימן שאלה גדול. התשלומים צריכים להיות קשורים לשלבי ביצוע אמיתיים, לא 'לפי לוח זמנים'.",
  },
  {
    q: "האם הקבלן חייב להחזיק ביטוח?",
    a: "כן — חובה. ביטוח עבודות קבלניות, ביטוח צד ג' וחבות מעבידים (אם יש עובדים). ללא ביטוח, אם יקרה משהו באתר — זו אחריות שלכם בפועל. לבקש העתק תעודה לפני תחילת עבודה.",
  },
  {
