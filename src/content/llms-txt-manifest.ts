...
export const llmsManifest: LlmsManifest = {
  ...
  summary:
    "חברת בנייה ישראלית המתמחה בבניית ממ״ד תקני, שיפור מיגון, ובהמשך התחדשות עירונית. ליווי מקצועי לבעלי דירות מהתכנון עד מסירת המפתח.",
  sections: [
    {
    ...
    },
    {
      ...
      items: [
        {
          url: "/pinui-binui",
          label: "פינוי בינוי 2026 - איך זה עובד, כמה זמן ומה מקבלים",
          description:
            "תשובה קצרה לכל שאלה: התהליך, כמה זמן, רוב 67%, תמורות, זכויות דיירים בני 70+, דייר סרבן, בחירת יזם, ואפשרות המכירה.",
        },
        {
        ...
        },
        {
          ...
          label: "זכויות קשישים בפינוי בינוי: גיל 70 ומעלה",
          description:
            "החלופות החובה (דיור מוגן, דירה חלופית, שתי דירות), איך לעגן בהסכם, טעויות נפוצות, ואפשרות המכירה.",
        },
        {
          url: "/pinui-binui/yorshim",
          label: "ירושת דירה בפרויקט פינוי בינוי פעיל 2026",
          description:
            "ליורשים שהמוריש כבר היה צד להסכם פינוי בינוי: מלכוד היורשים, נייר העמדה של רשות המסים, וסעיפים שחובה לעגן בהסכם. למכירת דירת ירושה כללית ראו /madrichim/mechirat-dira-beyerusha.",
        },
        {
        ...
        },
        {
          ...
          label: "יזם פינוי בינוי 2026: איך בוחרים",
          description:
            "12 שאלות שחובה לשאול, 8 דגלים אדומים, מי מחליט בפועל (הדיירים), ערבויות חובה, והשוואת הצעות.",
        },
        {
          url: "/pinui-binui/sarvan",
          label: "דייר סרבן פינוי בינוי: חוק 67%, זכויות וההליך",
          description:
        ...
        {
          url: "/pinui-binui/mechirat-dira",
          label: "מכירת דירה לפני פינוי בינוי 2026",
          description:
        ...
        {
          url: "/pinui-binui/diur-mugan",
          label: "מכירת דירה ומעבר לדיור מוגן 2026",
          description:
            "למשפחות ששוקלות למכור דירה בפינוי בינוי כדי לממן מעבר לדיור מוגן: זכויות גיל, תזמון מול לוח הזמנים של הפרויקט, ושכירות חוזרת כגשר.",
        },
        {
          url: "/madrichim/mechirat-dira-beyerusha",
          label: "מכירת דירה בירושה 2026",
          description:
            "מס שבח וצו ירושה, מה עושים כשיש כמה יורשים, אפשר למכור לפני צו הירושה, ואפשרות מכירת דירה תפוסה כשהמוכר ממשיך לגור בה.",
        },
        {
          url: "/tama-38",
    ...
    {
      title: "מכירת נכסים גדולים - בניין, נחלה, קרקע",
      items: [
        {
          url: "/mechira",
          label: "מכירת בניין, נחלה או קרקע 2026",
          description:
            "מי קונה בניין שלם, נחלה או קרקע עם היתר בישראל, ואיך מתחילים. שלושה מסלולים לבעלים בני 60+ וליורשים. הרכישה מבוצעת ישירות על ידי התחדשות בינוי ויזמות, עם כיסוי רישיון תיווך מקרקעין כרקע מקצועי, לא כשירות תיווך.",
        },
        {
          url: "/mechira/binyan-shalem",
          label: "מכירת בניין שלם 2026",
          description:
            "למי זה מתאים, מה צריך להכין (נסח, זכויות, היתרים), מה קובע את השווי, ותהליך מול קונה ישיר.",
        },
        {
          url: "/mechira/nachla",
          label: "מכירת נחלה 2026",
          description:
            "בן ממשיך, פיצול נחלה, היוון, ומה באמת עובר בעסקת מכירה של זכויות בנחלה מול רשות מקרקעי ישראל.",
        },
        {
          url: "/mechira/karka-im-heter",
          label: "מכירת קרקע עם היתר בנייה 2026",
          description:
            "זכויות בנייה, ייעוד קרקע, ומה זה היתר בנייה בתוקף בעסקת מכירת קרקע לרוכש ישיר או יזם.",
        },
        {
          url: "/mechira/yerusha",
          label: "ירשתי בניין או נחלה: מה עושים לפני מכירה 2026",
          description:
            "צו ירושה, מה קורה כשהיורשים לא מסכימים, ואיך מכירה משותפת ישירה לרוכש אחד חוסכת פירוק שיתוף בבית המשפט.",
        },
      ],
    },
    {
      ...
      items: [
        {
          url: "/about",
          label: "אודות התחדשות",
          description: "מי אנחנו, מודל העבודה והאחריות.",
        },
        {
          url: "/contact",
          label: "צור קשר",
