...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "ממ״ד יביל מותקן בחצר אחורית",
    serviceType: "ממ״ד טרומי",
    location: "אזור המרכז",
    capturedAt: "2026-03",
    stage: "finished",
    description:
      "ממ״ד יביל (טרומי) מותקן בחצר אחורית קטנה לאחר אישור פיקוד העורף נקודתי לכתובת. דלת הדף תקנית, חלון אטום, חיבור חשמל. התקנה מהירה ללא בנייה רטובה. החצר עובדה לדשא סינתטי.",
    image: "/projects/migunit-backyard-finished.jpg",
    alt: "ממ״ד יביל מותקן בחצר אחורית עם דשא סינתטי, דלת הדף לבנה וחלון תקני. התחדשות בינוי ויזמות",
    width: 1600,
    height: 1200,
    hasRealImage: true,
    imageType: "photograph",
    showcaseOnService: "prefab-mamad",
  },
  {
