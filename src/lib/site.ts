export const site = {
  ...
  description:
    "חברת התחדשות בינוי ויזמות. בניית ממ״דים, מיגון חדרים ומיגוניות בכל הארץ. תכנון, ביצוע ואישורי פקע״ר. קבלו הצעת מחיר ללא התחייבות.",
  shortDescription:
    "חברת בינוי ויזמות לבניית ממ״דים, מיגון ומיגוניות. אנחנו מבצעים.",
